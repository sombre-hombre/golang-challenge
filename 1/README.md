...
You will find [attached a zip file](http://web.archive.org/web/20200712092859/http://golang-challenge.com/data/ch1/golang-challenge-1-drum_machine.zip) containing the starting point for this challenge. Your goal is to implement the `drum` package and make it pass the provided tests.
...
![measure.png](http://web.archive.org/web/20200712092859im_/http://golang-challenge.org/images/measure.png)
...
-   Look around to see how data is usually [serialized/encoded](http://web.archive.org/web/20200712092859/http://golang.org/pkg/encoding/json/).
-   Become familiar with [encoding/binary package](http://web.archive.org/web/20200712092859/http://golang.org/pkg/encoding/binary/), especially [binary.Read](http://web.archive.org/web/20200712092859/http://golang.org/pkg/encoding/binary/#Read).
-   [hex.Dump](http://web.archive.org/web/20200712092859/http://golang.org/pkg/encoding/hex/#Dump) can very useful when debugging binary data (read more about [hex dump](http://web.archive.org/web/20200712092859/http://en.wikipedia.org/wiki/Hex_dump))

#### I don’t know where to start :(

[![Hex Viewer](http://web.archive.org/web/20200712092859im_/http://golang-challenge.org/images/hex.png "Hex Viewer")](http://web.archive.org/web/20200712092859/http://golang-challenge.org/images/hex.png)
...
Still not enough? Why not implementing the playback of the patterns using something like [portaudio](http://web.archive.org/web/20200712092859/https://godoc.org/code.google.com/p/portaudio-go/portaudio)?
